...
```{r ops, fig.cap="Mean values by gender and diabetes category", fig.height=6, fig.with=8}
...
# Restructure the data for ggplot2 (pivot to long format)
...
# Create the ggplot2 plot with grouped bars
ggplot2::ggplot(mean_values_long, aes(x = Variable, y = Mean_Value, fill = CLASS)) + # fill by CLASS
  ggplot2::geom_col(position = ggplot2::position_dodge()) +
  ggplot2::facet_wrap(~ Gender, scales = "free_y") +
  ggplot2::labs(
    title = "Mean Values by Variable, Gender, and Class",
    x = "Variable",
    y = "Mean Value",
    fill = "Diabetes Class"
  ) +
