...
pkgs <- c("EnsDb.Hsapiens.v75","knitr","HardyWeinberg","biomaRt","httr","jsonlite")
...
# Packages for genetic data analysis

## HardyWeinberg

We set to run through the package for Hardy-Weinberg equilirium (HWE). Three data sources are used: MN blood group in the documentation,
