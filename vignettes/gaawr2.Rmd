...
pkgs <- c("EnsDb.Hsapiens.v75","GMMAT","HardyWeinberg","MCMCglmm","SNPassoc","biomaRt",
...
ex <- gap::h2.jags(y,x,G,sigma.p=0.03,sigma.r=0.014)
...
which can be picked up through `pkgdown::build_reference()`. The refinement is greatly facilitated by GitHub `R-CMD-check.yaml` workflow.
