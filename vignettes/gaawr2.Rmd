...
knitr::kable(scalar_fields) %>%
  kableExtra::add_header_above(c("Basic Information" = ncol(scalar_fields))) %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"))
knitr::kable(target$geneticConstraint) %>%
  kableExtra::add_header_above(c("Basic Information" = ncol(target$geneticConstraint))) %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"))
knitr::kable(tractability_data) %>%
  kableExtra::add_header_above(c("Basic Information" = ncol(tractability_data))) %>%
