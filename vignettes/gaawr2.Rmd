...
The package gathers information, meta-data and scripts in a Henry-Stewart talk @zhao09.
...
An overview on proteomics is found from the relevant paper @suhre20. Some aspects of the proteogenomics is given by
...
a more in-depth data analysis coupled with development is surely fruitful and rewarding.
