...
-   Amend \_pkgdown.yml with gaawr2/web as articles rather than menu
    items.
-   Create `"{gaawr2, web}_cran.Rmd"` to enable direct access from CRAN.
...
-   It is unclear CRAN will follow shinygap.Rmd practice so use inst/doc
    instead.
    -   Consequently, this line is dropped from DESCRIPTION:
...
-   Carry forward DESCRIPTION/Description to both README.Rmd and
    gaawr2.Rmd
...
-   Revise Title/DESCRIPTION and track options()’s as suggested by Beni
    Altmann.
-   Revise vignette.
...
-   A first release which passes R CMD check –as-cran
    gaawr2_0.0.1.tar.gz.
